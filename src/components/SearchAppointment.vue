...
<div class="col-12 col-md-10 col-lg-7">
    <div class="input-group my-3">
        <input id="SearchApts" placeholder="Search" type="text" class="form-control" aria-label="Search Appointments" v-model="searchTerm">
        ...
        <div class="input-group-append">
            ...
            <div class="dropdown-menu dropdown-menu-right">
                ...
                <a class="dropdown-item d-flex justify-content-between" href="#" id="asc" @click="$emit('requestKey', 'asc')">
                    Asc
                    <font-awesome-icon icon="check" v-if="myDir === 'asc'" />
                </a>

                <a class="dropdown-item d-flex justify-content-between" href="#" id="desc" @click="$emit('requestKey', 'desc')">
                    Desc
